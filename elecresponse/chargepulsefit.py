...
def _(plt, readout_df):
    plt.plot(readout_df['charge_adc_words'][79][1,240:310], marker='.')
...
def _(are_hits_1, plot_charge_waveforms, plt, readout_df):
    ...
    for _event in range(10, 11):
        ...
        plot_charge_waveforms(readout_df=readout_df, event=_event, channel_range=_channel_range, timesize=255, overlay=True, range=[1830, 2060], create_fig=False, show_legend=True)
        plt.xlabel('[$\\mu$s]')
